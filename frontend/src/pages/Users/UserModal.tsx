      ...
      <div className="user-modal">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input type="password" id="password" name="password" placeholder={isEditMode ? "Nouveau mot de passe" : "Entrez le mot de passe"} value={formData.password || ''} onChange={handleChange} />
          </div>

          <div className="form-group">
            <label htmlFor="registration_number">Numéro d'immatriculation*</label>
            <input type="text" id="registration_number" name="registration_number" placeholder="Entrez le numéro d'inscription" value={formData.registration_number} onChange={handleChange} required />
          </div>
